...
- **DuckDB Foundation**. Copyright holder.  
  Bundled DuckDB C extension headers

- **Centre for Population Genomics**. Copyright holder.  
  ClinVarbitration 2.2.11 decision-policy semantics
