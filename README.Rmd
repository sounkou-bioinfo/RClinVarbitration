...
`cpg-clinvarbitration-2.2.11-disease-v1`, an attributed adaptation of Centre
for Population Genomics ClinVarbitration 2.2.11. It preserves the upstream
classification bins, 2016 ACMG threshold, 60/20 majority rule, review stars,
and qualified Illumina benign exclusion, while grouping independently by
allele and disease. Practice-guideline evidence precedes expert-panel evidence;
disagreement within the highest available tier remains `Conflicting`.
...
it does not perform VEP or PM5.
